...
public class AudioCallTest {
	...
	public void AudioCall() {
		...
		loginPage.verifyChatPage(userA,pinArray,password);
		driver=driver2;
		basePage=new BasePage(driver2);
		basePage.waitForWelcomeScreen();
		loginPage=basePage.gotoLogin();
		loginPage.verifyChatPage(friendToCall,"...".toCharArray(),"...");
		driver=driver1;
	...
	public void checkMinutes() {
		...
		loginPage.verifyChatPage(friendToCall,"...".toCharArray(),"...");
		callLocators2=new CallLocators(driver2);
		callLocators2.makeCallPhysical(userA,"Audio Call");
		driver=driver1;
		callLocators1=new CallLocators(driver1);
		callLocators1.acceptAudioCall();
		driver=driver2;
		int initialMinutes=callLocators2.getMinutes();
		callLocators2.gotoBackgroundandReturn();
		Assert.assertEquals(callLocators2.getMinutes(),initialMinutes-1);
	}
