...
public class TerminateChatTest {
	...
	public void terminateChat() {
		...
		singleChatLocators2.addFromChat();
		driver=driver1;
		singleChatLocators1.terminate();
		driver=driver2;
		Assert.assertTrue(singleChatLocators2.verifyChatErasedFromReceiver());
		driver=driver1;
		boolean isDeletedonSender=chatsPage1.verifyContactDeleted("...");
		driver=driver2;
		Assert.assertTrue(isDeletedonSender&&chatsPage2.verifyContactDeleted("..."));	
	}
